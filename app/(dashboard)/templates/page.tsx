            ...
            <div>
                <div className="flex flex-wrap items-center gap-[40px] justify-between">
                    ...
                    <div className="w-[calc(60%-55px)] flex flex-wrap items-center justify-end gap-[10px]">
                        <div className="border border-[#0456FF26] bg-[#0456FF26] rounded-[6px] flex flex-wrap items-center gap-3 px-[13px] py-[10px]">
                            ...
                            <span className="font-medium text-[12px] leading-[100%] text-[#0456FF]">ATS Friendly</span>
                        </div>
                        <div className="border border-[#0456FF26] bg-[#0456FF26] rounded-[6px] flex flex-wrap items-center gap-3 px-[13px] py-[10px]">
                            ...
                            <span className="font-medium text-[12px] leading-[100%] text-[#0456FF]">Modern Designs</span>
                        </div>
                        <div className="border border-[#0456FF26] bg-[#0456FF26] rounded-[6px] flex flex-wrap items-center gap-3 px-[13px] py-[10px]">
                            ...
                            <span className="font-medium text-[12px] leading-[100%] text-[#0456FF]">Easy to Customize</span>
                        </div>
                        <div className="border border-[#0456FF26] bg-[#0456FF26] rounded-[6px] flex flex-wrap items-center gap-3 px-[13px] py-[10px]">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            ...
                            <span className="font-medium text-[12px] leading-[100%] text-[#0456FF]">Professional Layouts</span>
                        </div>
                    </div>
                </div>
                ...
                {showActionButton && (
                    <button
                        ...
                        disabled={saving}
                        className="inline-block border border-[#0456FF] mt-[30px] bg-[#0456FF] text-white px-[24px] py-[12px] rounded-[6px] font-semibold text-[14px] fixed bottom-[60px] left-1/2 -translate-x-1/2 cursor-pointer hover:bg-transparent hover:text-[#0456FF] transition-colors duration-300 disabled:opacity-50"
                    >
                        {saving
