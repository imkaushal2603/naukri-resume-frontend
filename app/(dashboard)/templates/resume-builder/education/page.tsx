        ...
        <div className="p-5">
            <div className="grid grid-cols-3 gap-[27px] mb-4 max-[768px]:grid-cols-1">
                <div>
                    ...
                    <input type="text" value={form.degree} onChange={(e) => handleChange("degree", e.target.value)}
                ...
                <div>
                    ...
                    <input type="text" value={form.school} onChange={(e) => handleChange("school", e.target.value)}
                        className="w-full border border-[#0456FF26] rounded-[6px] py-[12px] px-[20px] text-[14px] leading-none text-black font-bold"
                    />
                </div>
                <div>
            ...
            <div className="grid grid-cols-3 gap-[27px] mb-4 max-[768px]:grid-cols-1">
                ...
                <div>
                    ...
                    <input type="text" value={form.gpa} onChange={(e) => handleChange("gpa", e.target.value)}
                        className="w-full border border-[#0456FF26] rounded-[6px] py-[12px] px-[20px] text-[14px] leading-none text-black font-bold"
                    />
                </div>
            </div>
            <label className="flex items-center gap-2 mb-[30px] text-[13px] font-semibold w-fit cursor-pointer">
                <input className="w-[18px] h-[18px]" type="checkbox" checked={form.isCurrent} onChange={(e) => handleChange("isCurrent", e.target.checked)} />
                Currently Studying
            </label>
        ...
        <div className="relative">
            ...
            <div className="flex flex-wrap gap-6">
                <div className="flex-1">
                                ...
                                <div className="border border-[#0456FF26] rounded-[10px]">
                                    <div className="border-b border-[#0456FF26] p-5 flex flex-wrap items-center justify-between">
                                        ...
                                        <div className="flex flex-wrap items-center gap-[15px]">
                                            <button onClick={() => (editingId === edu.id ? closeForm() : openEdit(edu))}
                                    ...
                                    {editingId === edu.id ? (
                                        ...
                                        <div className="p-5 flex flex-wrap gap-[20px]">
                                            ...
                                            <div className="w-[calc(100%-100px)] flex flex-col gap-y-[10px] justify-center">
                                                {edu.degree && (
                                                    <h6 className="font-bold text-[18px] leading-none text-black capitalize">{edu.degree}</h6>
                                                )}
                                                {(edu.school || edu.educationLevel) && (
                                                    <p className="flex gap-[8px] font-normal text-[15px] leading-none text-black items-center capitalize">
                    ...
                    {editingId === "new" && (
                        <div className="border border-[#0456FF26] rounded-[10px] mt-[20px]">{renderForm()}</div>
                    )}
