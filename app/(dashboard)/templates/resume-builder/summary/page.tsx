                ...
                <div className="flex-1">
                    <div className="border border-[#0456FF26] rounded-[10px] p-5">
                        ...
                        <div className="mb-4">
                            ...
                            <input id="resume-name" type="text" value={resumeName} onChange={(e: ChangeEvent<HTMLInputElement>) => setResumeName(e.target.value)}
                        ...
                        <div className="mb-6">
                            ...
                            <textarea id="summary-text" value={summary} onChange={(e: ChangeEvent<HTMLTextAreaElement>) => setSummary(e.target.value)} rows={8} maxLength={1000}
                        ...
                        <div className="flex flex-wrap items-center gap-[10px] bg-[#0456FF26] border border-[#0456FF4D] rounded-[6px] px-[20px] py-[14px]">
                            <svg className="w-[18px]" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            ...
                            <h6 className="font-medium text-[16px] leading-none text-[#000024] w-[calc(100%-28px)]"><span className="text-[#0456FF]">Tip:</span> A good summary is 2-4 lines long and highlights your top skills, experience and value.</h6>
                        </div>
                    </div>
