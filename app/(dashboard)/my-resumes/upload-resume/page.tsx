    ...
    return (
        <div className="relative">
            ...
            <div className="flex flex-wrap gap-[30px] max-w-[900px] mt-[50px]">
                <div className="w-[calc(50%-15px)] border border-[#0456FF26] rounded-[8px] p-[30px] pb-[70px] flex flex-col items-center justify-center text-center gap-y-[20px] max-[768px]:w-full">
