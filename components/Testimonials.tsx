          ...
          <Swiper
            ...
            {testimonials.map((item) => (
              <SwiperSlide key={item.id} className="!h-auto">
                <div className="bg-white rounded-[24px] py-[30px] pl-[25px] pr-[12px] shadow-[0px_2px_7px_0px_#CACACADB] text-center relative h-full max-[768px]:p-[20px]">
                  <div>
                    <div className="w-full flex flex-wrap mb-[10px] max:[768px]:gap-[12px] max:[768px]:justify-between max-[768px]:justify-between max-[768px]:gap-[12px]">
                      ...
                      <div className="w-[calc(100%-95px)] flex justify-center items-end pr-[16px] flex-col gap-y-[15px] max-[768px]:w-full max-[768px]:items-center max-[768px]:order-2 max-[768px]:p-0">
